...
namespace TUSA.Data
{
    public abstract class BaseRepository<T> : IReadRepository<T> where T : Domain.Entities.BaseEntity
    {
        ...
        public IPaginate<T> GetRefList(int id, Expression<Func<T, bool>> predicate = null, Func<IQueryable<T>, IOrderedQueryable<T>> orderBy = null, Func<IQueryable<T>, IIncludableQueryable<T, object>> include = null,
        ...
        public virtual IEnumerable<T> GetAllList(string OrderBy)
        {
            IQueryable<T> query = _dbSet.AsNoTracking(); 
        ...
        private Func<IQueryable<T>, IOrderedQueryable<T>> GetOrderByFunc(string name, bool ascending)
        {
