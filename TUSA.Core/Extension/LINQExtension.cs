...
namespace TUSA.Core.Extension
{
    ...
    public static class LINQExtension
    {
        ...
        /// <summary>
        /// Get compare of list and return modifyed, added and can deleted
        /// </summary>
        ...
        {
            CollectionCompareResult<T> result = new CollectionCompareResult<T>();
